...
["SALSAS","VALENTINA NEGRA","350 ML",0,1,1,20],
["SALSAS","VALENTINA AZUL","350 ML",0,1,1,25],
["SALSAS","LA GLORIA (ROJA)","250 ML",0,1,1,40],
["SALSAS","LA GLORIA (AMARILLA)","250 ML",0,1,3,40],
["SALSAS","LOP JU (ROJA)","250 ML",0,1,1,40],
["SALSAS","LOP JU (AMARILLA)","250 ML",0,1,3,40],
["SALSAS","LOS JAROCHOS (AMARILLA)","150 ML",0,1,3,40],
["SALSAS","SALSA INGLESA","250 ML",0,1,1,70],
["SALSAS","SALSA BRUJA","40 ML",0,1,1,30],
["SALSAS","ACEITE DE OLIVO","350 ML",0,1,1,105],
["SALSAS","VALENTINA BOLSITA","1 KG",0,1,1,50],
["SALSAS","SALADITAS","1 PAQUETE",0,1,1,60],
...
if st.button("🚀 Calcular pedido óptimo"):
    ...
    st.dataframe(df[["Familia","Producto","Pide","Inventario","Pedido óptimo","Costo pedido"]])
    ...
    csv_detalle = df[["Familia","Producto","Pide","Inventario","Pedido óptimo","Costo pedido"]]
